...
// ============================================================================
// ONE-TIME MAP GUIDE IMPORT - DELETE THIS ENTIRE SECTION AFTER FIRST DEPLOY
// ============================================================================
// Add this at the very bottom of server.js, AFTER the app.listen() section
// After Railway deploys and you verify the map guide works, delete this entire section

setTimeout(() => {
  console.log('');
  console.log('🗺️  Starting Map Guide Import...');
  
  const mapGuideContent = `<div class="map-guide-container">
    <div class="map-intro">
    ...
    <div class="location-section main-location">
        ...
        <div class="location-details">
            ...
            <img src="/images/map/10000000000001330000012854DCF66E.jpg" alt="TerraVilla Location 22" class="map-image" loading="lazy">
            <p>General Store</p>
            <p>Universal trader/shop</p>
            <p class="npc-info">👥 <strong>NPC: Oswald</strong></p>
            <img src="/images/map/10000000000001DA00000193996762D9.jpg" alt="TerraVilla Location 23" class="map-image" loading="lazy">
        </div>
    </div>

    <div class="location-section main-location">
        <h3 class="location-header">📍 STARTING FROM BELOW GENERAL STORE:</h3>
        <div class="location-details">
            <p>The Rainbow Stairs (Left stairs) leads to Guildhall and Football Fields (Pixels Futbol and other games) -</p>
            <p class="npc-info">👥 <strong>NPCs: Maddox (Guildhall) Leo (Futbol) Luke (Combat, Capture the Flag, King Of The Hill)</strong></p>
            <img src="/images/map/10000000000002C0000001C1D68A8F12.jpg" alt="TerraVilla Location 24" class="map-image" loading="lazy">
            <p>Quest Board (Next to fountain)</p>
            <p>Community quest station</p>
            <p class="npc-info">👥 <strong>NPC: Quest Master Quinn</strong></p>
            <img src="/images/map/1000000000000271000001B169C47429.jpg" alt="TerraVilla Location 25" class="map-image" loading="lazy">
            <p>Farming Equipment Shop (Next to Bank, behind quest board)</p>
            <p>Alternative seed shop</p>
            <p class="npc-info">👥 <strong>NPC: Freida</strong></p>
            <img src="/images/map/10000000000001B5000001D2D985BFF1.jpg" alt="TerraVilla Location 26" class="map-image" loading="lazy">
            <p>The Beach (Below fountain, walk down path)</p>
            <p>Beach activities area, The Carnival and NFT land The Falls</p>
            <p class="npc-info">👥 <strong>NPCs: Caleb (Beach Games) Mary (Wayfarer Town Entrance) Arjun (NFT The Falls Entrance) Carnival Entrance Booth (See Carnival below)</strong></p>
            <img src="/images/map/100000000000027A0000027AFBB0020A.jpg" alt="TerraVilla Location 27" class="map-image" loading="lazy">
        </div>
    </div>
    ...
    <div class="location-section main-location">
        ...
        <div class="location-details">
            <p>Mini-game hub (Behind Hearth Hall at the Top)</p>
            <p class="npc-info">👥 <strong>NPCs: Ticket Booth (Get Ticket Rings) Joe (Chef Simulation) Fiona (Fishing Mini-Game - Reel Rush) Nicki (Farming Mini-Game Crop Clash) Penny (Energy Giving Game - Whac-A-Mallet) Freddie (Red Light Green Light) Francis (Claw Machine) Remy (Rat Race) Petra (Knock Down the Cans)</strong></p>
            <img src="/images/map/10000000000003C3000002150D72B611.jpg" alt="TerraVilla Location 28" class="map-image" loading="lazy">
        </div>
    </div>

    <div class="location-section main-location">
        <h3 class="location-header">📍 KEY EXTERIOR AREAS & CONNECTIONS:</h3>
        <div class="location-details">
            <p>TerraVilla is the central hub</p>
            <p>Multiple exits lead to various regions</p>
            <p>Main roads connect to NFT lands and special zones</p>
            <img src="/images/map/100000000000058200000252C9E7FC01.jpg" alt="TerraVilla Location 29" class="map-image" loading="lazy">
            <img src="/images/map/1000000000000630000002FC78BF2A52.jpg" alt="TerraVilla Location 30" class="map-image" loading="lazy">
            <img src="/images/map/10000000000004430000027BC18D50D3.jpg" alt="TerraVilla Location 31" class="map-image" loading="lazy">
            <img src="/images/map/1000000000000456000002934C91E5FC.jpg" alt="TerraVilla Location 32" class="map-image" loading="lazy">
            <img src="/images/map/1000000000000455000002892211325C.jpg" alt="TerraVilla Location 33" class="map-image" loading="lazy">
            <img src="/images/map/100000000000041C0000025B45DED037.jpg" alt="TerraVilla Location 34" class="map-image" loading="lazy">
            <img src="/images/map/10000000000004D50000029D2D2D464E.jpg" alt="TerraVilla Location 35" class="map-image" loading="lazy">
            <img src="/images/map/100000000000037E0000027F005591A3.jpg" alt="TerraVilla Location 36" class="map-image" loading="lazy">
            <img src="/images/map/10000000000003A4000002FEF62852BF.jpg" alt="TerraVilla Location 37" class="map-image" loading="lazy">
        </div>
    </div>
...
@media (max-width: 768px) {
  ...
  db.get('SELECT id FROM pages WHERE slug = ?', ['terravilla-map-guide'], (err, row) => {
    if (err) {
      console.error('❌ Map guide import check failed:', err.message);
      return;
    }
    
    if (row) {
      console.log('⚠️  Map guide already exists - skipping import');
      console.log('   (Delete this code section from server.js now)');
      return;
    }
    
    // Import it
    db.run(`INSERT INTO pages (
      slug, title, content, category, difficulty, summary, author_id, created_at, updated_at
    ) VALUES (?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)`,
      [
      ...
      function(insertErr) {
        if (insertErr) {
          console.error('❌ Map guide import failed:', insertErr.message);
        } else {
          ...
          console.log('');
          console.log('🎉 SUCCESS! Now delete this entire code section from server.js');
        }
      }
    );
  });
...
// ============================================================================
// END OF ONE-TIME IMPORT - DELETE EVERYTHING ABOVE THIS LINE AFTER IT WORKS
// ============================================================================
