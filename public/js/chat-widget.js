...
class ChatWidget {
  ...
  <img src="/images/ninja head no background.png" alt="Dojo" style="width:40px; height:40px;">
</button>
...
const avatar = type === 'user' 
  ? '👤' 
  : '<img src="/images/ninja head no background.png" style="width:40px; height:40px; border-radius:50%;">';
